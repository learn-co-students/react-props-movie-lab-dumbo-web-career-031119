  ...
  render() {
    return (
      <div className="movie-card">
        <CardFront poster = {posterMap[this.props.movies.poster]} />
        <CardBack title = {this.props.movies.title} genre = {this.props.movies.genres} IMDBRating = {this.props.movies.IMDBRating}/>
      </div>
    )
  }
}
